<script setup>
useHead({
  title: 'Cookies · Pleitegeier',
  meta: [
    {
      name: 'description',
      content:
        'Informationen zur Verwendung von Cookies auf Pleitegeier – erfahre, wie und warum wir Cookies nutzen.',
    },
  ],
})
</script>
...
<template>
  <section class="content-wrapper text-gray-800 dark:text-gray-200">
    ...
    <p class="text-lg mb-6 leading-relaxed">
      Um dir die bestmögliche Nutzererfahrung zu bieten, verwendet
      <strong class="text-brand-600 dark:text-brand-300">Pleitegeier</strong>
      Cookies. Diese helfen uns, unsere Website zu analysieren, Inhalte zu personalisieren
    ...
    <ul class="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300 leading-relaxed">
      <li>
        <strong>Essenzielle Cookies:</strong> Notwendig für die grundlegende
        Funktionalität der Website.
      </li>
      <li>
        <strong>Statistik-Cookies:</strong> Helfen uns, das Nutzerverhalten anonymisiert
        zu analysieren, um das Angebot zu verbessern.
      </li>
      <li>
        <strong>Funktionale Cookies:</strong> Merken sich deine Einstellungen und
        Präferenzen, z. B. Dark-Mode oder Sprache.
      </li>
      <li>
        <strong>Optionale Cookies:</strong> Dienen zur Verbesserung der Nutzererfahrung
        oder zur Integration externer Inhalte (z. B. eingebettete Diagramme).
      </li>
    </ul>
    ...
    <p class="text-sm text-gray-500 dark:text-gray-400 mt-10">
