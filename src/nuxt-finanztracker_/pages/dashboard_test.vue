<template>
  <div class="p-6 max-w-screen-xl mx-auto space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div class="col-span-1 md:col-span-2 bg-gray-100 rounded-lg p-6 flex flex-col items-center justify-center min-h-[180px]">
        <p class="text-lg font-semibold mb-4">Verlauf des Kontostands</p>
        <svg class="w-12 h-12 text-gray-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" d="M3 3v18h18M4 14l4-4 5 5 7-7" />
        </svg>
      </div>
