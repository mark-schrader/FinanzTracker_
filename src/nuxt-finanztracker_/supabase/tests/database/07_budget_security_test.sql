...
--Test: Kann User 2 die Budgets von User 1 sehen?
...
--Überprüfen, ob User 2 das Budget von User 1 sehen kann
  SELECT is_empty(
  $$ SELECT * FROM public.budgets WHERE user_id = (SELECT userid FROM public."user" WHERE supabaseid = '11111111-1111-1111-1111-111111111111') $$,
  'User 2 kann das Budget von User 1 nicht sehen'
);
