...
--Test: Kann User 2 die Expenses von User 1 sehen?
...
--notwendig aufgrund von Foreign Key Beziehungen zwischen Expenses und Categories
...
INSERT INTO public.expenses (user_id, amount, category_id, date, note) VALUES ( (SELECT userid FROM public."user" WHERE supabaseid = '11111111-1111-1111-1111-111111111111'), 12000, '1', '2023-09-08', 'Auto');
--Authentifizierng zu User 2 wechseln
SET "request.jwt.claim.sub" TO '22222222-2222-2222-2222-222222222222';
SET ROLE authenticated;

--Überprüfen, ob User 2 das Expense von User 1 sehen kann
  SELECT is_empty(
  $$ SELECT * FROM public.expenses WHERE user_id = (SELECT userid FROM public."user" WHERE supabaseid = '11111111-1111-1111-1111-111111111111') $$,
  'User 2 kann das Expense von User 2 nicht sehen'
);
