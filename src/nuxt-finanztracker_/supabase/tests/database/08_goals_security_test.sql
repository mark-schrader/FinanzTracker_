...
--Überprüfen, ob User 2 das Goal von User 1 sehen kann
  SELECT is_empty(
  $$ SELECT * FROM public.goals WHERE user_id = (SELECT userid FROM public."user" WHERE supabaseid = '11111111-1111-1111-1111-111111111111') $$,
  'User 2 kann das Goal von User 1 nicht sehen'
);
