...
|Bedürfnisse / Ziele
a|
* Klare Übersicht über Einnahmen & Ausgaben
* Frühwarnsystem bei drohendem Geldmangel
* Automatische Erinnerungen für Miete & Semesterbeiträge
* Motivation, regelmäßig etwas für den Sommerurlaub zu sparen

|Hindernisse / Frustration
a|
* kein großes Interesse an Finanzen,
* verliert aber schnell den Überblick über ihre Ausgaben
* Angst, am Monatsende kein Geld mehr übrig zu haben
...
* muss Ein-& Ausnahemn gut übeischtlich einsehen können 
