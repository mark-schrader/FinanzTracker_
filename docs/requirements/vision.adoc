...
| Transparente Erfassung von Einnahmen | hoch | Möglichkeit zur manuellen Eingabe von Einnahmen inkl. Datum, Betrag, Kategorie | SE1

| Transparente Erfassung von Ausgaben | hoch |  Erfassung von Ausgaben inkl. Betrag, Datum, Kategorie sowie Wiederholungseinstellungen | SE1
...
| Einfache und verständliche Nutzung | hoch | Intuitives und minimalistisches UI für einfache Bedienung |  SE1
...
| Individuelle Anpassung der Darstellung | gering | Benutzerdefinierte Gestaltung von Farben, Diagrammen und Zeitraumfiltern |  SE2
...
| Reduzierung manueller Wiederholungseingaben | mittel |Automatische Übernahme wiederkehrender Einnahmen und Ausgaben in das nächste Intervall (Dauerauftrag) |  SE2
