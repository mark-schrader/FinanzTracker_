...
| die | Probleme mit dem Management der persönlichen Finanzen haben
| ist | Budget Buddies 
| eine | FinTech, PFM Anwendung
| die | das Budget der Student*innen nicht nur schont, sondern sogar verbessert
| anders als | abogebundene Alternativen, die den Student*innen noch zusätzlich auf der Tasche liegen
| ist unser Produkt | genau auf die finanzielle Situation von Studierenden zugeschnitten
|===
