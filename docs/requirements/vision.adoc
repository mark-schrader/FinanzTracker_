...
| Eintragen von Finanzeinnahmen | sehr wichtig | Möglichkeit zur manuellen Eingabe von Einnahmen inkl. Datum, Betrag, Kategorie | SE1
| Anmelden und Ausloggen | sehr wichtig | Authentifizierung durch Username und Password | SE2
| Eintragen von Finanzausgaben | sehr wichtig |  Erfassung aller Ausgaben mit Tags/Kategorien und Wiederholungseinstellungen | SE1
| Kategorisierung von Einnahmen und Ausgaben | wichtig | System zur Verwaltung und Anpassung von Kategorien | SE1
| Übersicht über aktuelle Finanzen | sehr wichtig | Dashboard mit grafischer und tabellarischer Darstellung aktueller Finanzlage | SE1
| Prognosen | nicht wichtig | Vorhersage zukünftiger Finanzentwicklungen basierend auf bisherigen Daten | SE2
| Spar-challenges | wichtig | Vordefinierte oder benutzerdefinierte Challenges mit Fortschrittsanzeige |  SE2
| Wiederkehrende Ausgaben automatisch ins nächste Semester übernehmen | wichtig | Automatisches Kopieren der wiederkehrenden Ausgaben ins neue Semester (Grundkonzept) |  SE2
| Finanzdaten-Export | nicht wichtig | Export als CSV, Excel oder PDF zur Archivierung oder Analyse |  SE2
| Simples Layout | sehr wichtig | Intuitives und minimalistisches UI für einfache Bedienung |  SE1
| Zweite Sprache (Englisch) | wichtig |  Umschaltfunktion zwischen Deutsch und Englisch |  SE2
| Dark-Mode | nicht wichtig | Dunkles Farbschema für angenehme Nutzung bei wenig Licht |  SE2
| Individuelle anpassbare Elemente | nicht wichtig | Benutzerdefinierte Gestaltung von Farben, Diagrammen und Zeitraumfiltern |  SE2
| Modulares Layout (Entfernen von Modulen möglich) |  nicht wichtig | Frei anpassbares Interface, bei dem einzelne Module ein-/ausblendbar sind |  SE2
