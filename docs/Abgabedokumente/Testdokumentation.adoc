...
- User-Authentifizierung (funktion Login)
- Challange: Buttons vorhanden
- Reiter-Navigation
- Dashboard: Kontostand vorhanden, Diagramm-Überschrift einsehbar, manueller Zeitraum ansprechbar
- Kontobewegung: Einnahme- und Ausgabenerfassung, Dauerauftrag und Kategorie-Verwalten Modal vorhanden
- Export: Überschrift vorhanden
