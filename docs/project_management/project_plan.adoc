...
In dem Projekt Plan stellen wir sowohl die Organisation, Praktiken und Bewertung, unsere Deployment Strategie, als auch unsere Erkenntnisse am Ende jeder Iteration dar. 
