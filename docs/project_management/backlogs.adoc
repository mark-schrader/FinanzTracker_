...
== Risk-Board
Im Risk-Board sind unsere potentiellen Risiken aufgelistet, die unser Projekt zum stocken bringen können. Die Risiken sind in gering, mittel und hoch eingestuft und ihrem aktuellen Bewertungstatus Neu, Analyse, Bewertung und Bewältigung. 
